...
namespace MudBlazorWebApp1.Migrations
{
    ...
    [Migration("20250316142349_Merge")]
    partial class Merge
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MudBlazorWebApp1.Components.Models.Car", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MudBlazorWebApp1.Components.Models.Customer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MudBlazorWebApp1.Components.Models.Fee", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MudBlazorWebApp1.Components.Models.Payment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MudBlazorWebApp1.Components.Models.Reservation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MudBlazorWebApp1.Components.Models.Fee", b =>
                {
                    b.HasOne("MudBlazorWebApp1.Components.Models.Payment", "Payment")
                        .WithMany()
            ...
            modelBuilder.Entity("MudBlazorWebApp1.Components.Models.Payment", b =>
                {
                    b.HasOne("MudBlazorWebApp1.Components.Models.Reservation", "Reservation")
                        .WithMany()
            ...
            modelBuilder.Entity("MudBlazorWebApp1.Components.Models.Reservation", b =>
                {
                    b.HasOne("MudBlazorWebApp1.Components.Models.Car", "Car")
                        .WithMany("Reservations")
                        .HasForeignKey("CarId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MudBlazorWebApp1.Components.Models.Customer", "Customer")
                        .WithMany("Reservations")
